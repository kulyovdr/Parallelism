...
const std::chrono::duration<double> dgemv_parallel(std::shared_ptr<double[]> matr, std::shared_ptr<double[]> vecIn, std::shared_ptr<double[]> vecOut, int numThr, const int m, const int n)
{
